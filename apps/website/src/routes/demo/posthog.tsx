      ...
      <div className="max-w-md mx-auto">
        ...
        {!isConfigured && (
          <div className="mb-4 p-4 bg-yellow-900/50 border border-yellow-600 rounded-lg">
            <p className="text-yellow-200 text-sm">
              <strong>Warning:</strong> VITE_POSTHOG_KEY is not configured. Events won't be sent to
              PostHog. Add it to your <code className="bg-yellow-900 px-1 rounded">.env</code> file.
            </p>
          </div>
        )}
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          <p className="text-gray-400 mb-4">
            Click the button below to send events to PostHog. Check your PostHog dashboard to see
